...
public class Student implements Comparable<Student>{
	...
	private int year;
	protected String[]grades; // any of my descendants can call this, but no one else
	...
	public String[] getGrades(){
		return Arrays.copyOf(grades,grades.length); // return a copy so the user can't tamper
	}
